...
#for fam in list(set(final_names)):
#    plot_df = df[df.family == fam]
#df = df[df.family.str.contains("PI")]
#print(df[~df.group.str.contains("Q")])
#df = df[df.group.str.contains("Q")]
fig, ax = plt.subplots(figsize=(9,6))
sns.scatterplot(x=f"PC1 ({pc1}%)", y=f"PC2 ({pc2}%)", hue="group", data=df, linewidth=0, alpha=0.6, palette={"Q1":"#F0A0FF", "Q2":"#0075DC", "Q3":"#993F00",
"Q4":"#4C005C", "Q5":"#191919", "Q6":"#005C31", "Q7":"#2BCE48", "Q8":"#FFCC99",
"Q9":"#808080", "Q10":"#94FFB5", "Q11":"#8F7C00", "Q12":"#9DCC00", "Q13":"#C20088",
"Q14":"#003380", "Q15":"#FFA405"}, size=10, legend="full", ax=ax)
...
plt.tight_layout()
plt.savefig("pca.admixture.jpg", dpi=600)
